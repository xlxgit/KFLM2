...
df1_1 = pd.read_csv('./KFLM2/auc_results_BACE_scaffold.csv')
df1_2 = pd.read_csv('./KFLM2/auc_results_BBBP_scaffold.csv')
df1_3 = pd.read_csv('./KFLM2/auc_results_ClinTox_scaffold.csv')
df1_4 = pd.read_csv('./KFLM2/auc_results_sider_scaffold.csv')
df1_5 = pd.read_csv('./KFLM2/auc_results_Tox21_scaffold.csv')

data_list = [df1_1['AUC'],  df1_2['AUC'], df1_3['AUC'], df1_4['AUC'],  df1_5['AUC']]


df2_1 = pd.read_csv('CoMPT/auc_results_bace_scaffold.csv')
df2_2 = pd.read_csv('CoMPT/auc_results_bbbp_scaffold.csv')
df2_3 = pd.read_csv('CoMPT/auc_results_clintox_scaffold.csv')
df2_4 = pd.read_csv('CoMPT/auc_results_sider_scaffold.csv')
df2_5 = pd.read_csv('CoMPT/auc_results_tox21_scaffold.csv')

data_list2 = [df2_1['auc'],  df2_2['auc'], df2_3['auc'], df2_4['auc'], df2_5['auc']]

df3_1 = pd.read_csv('MoleSG/auc_results_bace_scaffold.csv')
df3_2 = pd.read_csv('MoleSG/auc_results_bbbp_scaffold.csv')
df3_3 = pd.read_csv('MoleSG/auc_results_clintox_scaffold.csv')
df3_4 = pd.read_csv('MoleSG/auc_results_sider_scaffold.csv')
df3_5 = pd.read_csv('MoleSG/auc_results_tox21_scaffold.csv')
...
plt.title('Scaffold Splitting', fontsize=14)
plt.xlabel('Dataset')
...
# 6. 调整布局
plt.tight_layout()
plt.savefig("prediction_auc_methond_scaffold_compare.png", dpi=300, bbox_inches='tight')
