...
import random
from models import CombinedModel, GCNModel 
# 加载模型和分词器
...
for idx in range(10):
    ...
    input_dim = 64
    gcn_model = GCNModel(input_dim, hidden_dim=hidden_dim, dropout=dropout).to(device)
    ...
    for epoch in range(num_epochs):
        ...
        for (smiles_embeddings, graph_data), logP_values in train_loader:
            ...
            # 前向传播
            predictions = gcn_model(graph_data)
